...
# <end id="_1313_14472_8342"/> 放到市场上面销售
...
def my_test_benchmark_update_token():
    import redis
    # host_r = '192.168.1.104'
    host_r = '138.128.194.6'
    port_r = 6379
    db_r = 15
    conn = redis.Redis(host=host_r, port=port_r, db=db_r)
    conn.flushdb()
    benchmark_update_token(conn, 10)


if __name__ == '__main__':
    unittest.main()
    # my_test_benchmark_update_token()
